			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.columnistas.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.columnistas.index', 'method' => 'GET']) !!}
                        ...
                        <table class="table table-striped table-bordered" id="table2">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-4">
                                        {!! Form::text('titulo', null, ['class' => 'form-control input-sm', 'placeholder' => 'Columnista']) !!}
                                    </td>
                                    <td class="col-md-2">
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.columnistas.index') !!}" class="btn btn-danger">
                    ...
                    <table class="table table-striped table-responsive">
                        <thead>
                            <tr>
                                <th class="text-center">Columnista</th>
                        ...
                        <tbody>
                            @foreach($rows as $item)
                                @php
                                    ...
                                    $row_publicar = $item->publicar ? '<span class="badge badge-success badge-roundless">Activo</span>' : '<span class="badge badge-default badge-roundless">No activo</span>';
                                @endphp
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.columnistas.edit', $row_id) }}">Editar</a></li>
                                            <li><a href="{{ route('admin.columnistas.columna.index', $row_id) }}">Columnas</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
{!! Form::open(['route' => ['admin.columnistas.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
