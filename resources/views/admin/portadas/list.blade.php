			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.portadas.create') }}" class="btn green">
                                Agregar registro
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.portadas.edit', $row_id) }}">Editar</a></li>
                                            <li><a href="#delete" class="btn-delete">Eliminar</a></li>
{{--                                            <li><a href="{{ route('admin.portadas.img.list', $row_id) }}">Galería de Imagenes</a></li>--}}
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
{!! Form::open(['route' => ['admin.portadas.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
