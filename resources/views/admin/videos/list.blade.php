			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.videos.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.videos.index', 'method' => 'GET']) !!}
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.videos.edit', $row_id) }}">Editar</a></li>
...
{!! Form::open(['route' => ['admin.videos.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
