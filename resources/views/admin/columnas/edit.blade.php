...
@section('contenido_admin_title')
    Editando Columna de {{ $columnista_nombre }}
@stop
...
<div class="row">
	...
	<div class="col-lg-12">
        ...
        <div class="row">
            ...
            {!! Form::model($post, ['route' => ['admin.columnistas.columna.update', $columnista_id, $post->id], 'method' => 'PUT', 'files' => 'true', 'id' => 'formRegister']) !!}
                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('admin.columnistas.columna.index', $columnista_id) }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                                </div>
