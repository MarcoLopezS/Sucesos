...
@php
    $columnista_id = $prin->id;
    $columnista_nombre = $prin->nombre_completo;
@endphp

@section('contenido_admin_title')
	Columnas de {{ $columnista_nombre }}
@stop
			...
			<div class="portlet light bordered">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.columnistas.columna.create', $columnista_id) }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => ['admin.columnistas.columna.index', $columnista_id], 'method' => 'GET']) !!}
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.columnistas.columna.index', $columnista_id) !!}" class="btn btn-danger">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.columnistas.columna.edit', [$columnista_id, $row_id]) }}">Editar</a></li>
...
{!! Form::open(['route' => ['admin.columnistas.columna.destroy', $columnista_id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
