        ...
        <div class="col-lg-12">
            ...
            <div class="portlet box blue-hoki">
                ...
                <div class="portlet-body">
                    ...
                    <a href="{{ route('admin.noticias.img.list', $posts->id) }}" class="btn btn-primary">Ver fotos</a>
                    <a href="{{ route('admin.noticias.index') }}" class="btn btn-primary">Ir a lista de noticias</a>
