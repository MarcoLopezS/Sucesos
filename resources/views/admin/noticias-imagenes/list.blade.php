            ...
            <div class="portlet box blue-hoki borderNone">
                ...
                <div class="portlet-body">   
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.noticias.img.create', $posts->id) }}" class="btn green">
                                Agregar registro
                    ...
                    <div class="table-toolbar">
                        ...
                        {!! Form::open(['route' => ['admin.noticias.img.order', $posts->id], 'method' => 'POST', 'id' => 'FormOrder']) !!}
...
{!! Form::open(['route' => ['admin.noticias.img.delete', $posts->id, ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
